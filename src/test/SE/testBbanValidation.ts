...
describe('SwedishBbanValidation', () => {
    ...
    describe('when validating with clearing number specified in the account number', () => {
        it('should validate a valid Swedish BBAN account', () => {
            chai.expect(
                validation.validate({ accountNumber: '54401122003' } /* prod */)
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
        ...
        it('should validate a valid Swedish BBAN account as object input', () => {
            chai.expect(
                validation.validate({ accountNumber: '54401122003' })
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
        ...
        it('should validate a valid type 1.1 Swedish BBAN account (danskebank)', () => {
            chai.expect(
                validation.validate({ accountNumber: '12811122001' })
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
        ...
        it('should validate a valid type 1.2 Swedish BBAN account (Dnb)', () => {
            chai.expect(
                validation.validate({ accountNumber: '91951122005' })
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
        ...
        it('should validate a valid type 1.2 Swedish BBAN account (Lansforsakringer WASA Bank)', () => {
            chai.expect(
                validation.validate({ accountNumber: '90231122006' })
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
        ...
        it('should validate a valid type 2.1 Swedish BBAN account (Sparebanken syd)', () => {
            chai.expect(
                validation.validate({ accountNumber: '95701122211004' })
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
        ...
        it('should validate a valid type 2.2 Swedish BBAN account (Handelsbanken)', () => {
            chai.expect(
                validation.validate({ accountNumber: '6000112221009' })
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
        ...
        it('should invalidate an invalid Swedish BBAN account', () => {
            chai.expect(
                validation.validate({ accountNumber: '54401122004' })
            ).to.deep.equal({
                valid: false,
        ...
        it('should invalidate an unknown clearing number in a Swedish BBAN account (type 0.0)', () => {
            chai.expect(
                validation.validate({ accountNumber: '90307777777' })
            ).to.deep.equal({
                valid: false,
                reason: 'Invalid Swedish bban',
            })
        ...
        it('should invalidate a Swedish BBAN account with invalid syntax', () => {
            chai.expect(
                validation.validate({ accountNumber: '544088888888' })
            ).to.deep.equal({
                valid: false,
    ...
    describe('4 char clearing number type 2.3 (that starts with 8) Swedish Swedbank BBAN account ', () => {
        ...
        it('should validate a valid type 2.3 Swedish BBAN account (Swedbank)', () => {
            // TODO: here
            chai.expect(
                validation.validate({ accountNumber: '83880122211006' })
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
    ...
    describe('5 char clearing number type 2.3 (that starts with 8) Swedish Swedbank BBAN account ', () => {
        ...
        it('should validate a valid type 2.3 Swedish BBAN account (Swedbank)', () => {
            chai.expect(
                validation.validate({ accountNumber: '838890122211006' })
            ).to.deep.equal({
                valid: true,
                reason: null,
            })
